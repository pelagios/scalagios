...
import org.pelagios.legacy.api.Place
import org.pelagios.legacy.graph.{Path, PlaceVertex}
import org.pelagios.legacy.graph.Constants._
import org.pelagios.legacy.graph.io.PelagiosGraphIOBase
import org.pelagios.legacy.graph.exception.GraphIOException
...
import org.pelagios.legacy.graph.PlaceVertex
